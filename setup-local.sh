...
echo "   ${YELLOW}uv run uvicorn simple_tavily_adapter.main:app --reload --port 8001${NC}"
echo ""
echo "4. Test the API:"
echo "   ${YELLOW}curl -X POST http://localhost:8001/search -H 'Content-Type: application/json' -d '{\"query\":\"test\",\"max_results\":3}'${NC}"
echo ""
